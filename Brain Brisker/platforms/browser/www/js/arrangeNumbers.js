...
else if(level==3)
{
   ...
   document.write("<tr>");
   document.write('<td> <img name=i15 width=30px height=30px src="" onclick=moves1(15)></td>');
   document.write('<td> <img name=i16 width=30px height=30px src="" onclick=moves1(16)></td>');
   document.write('<td> <img name=i17 width=30px height=30px src="" onclick=moves1(17)></td>');
   document.write('<td> <img name=i18 width=30px height=30px src="" onclick=moves1(18)></td>');
   document.write('<td> <img name=i19 width=30px height=30px src=""  onclick=moves1(19)></td>');
   document.write("</tr>");
   document.write("<tr>");
   document.write('<td> <img name=i20 width=30px height=30px src="" onclick=moves1(20)></td>');
   document.write('<td> <img name=i21 width=30px height=30px src="" onclick=moves1(21)></td>');
   document.write('<td> <img name=i22 width=30px height=30px src="" onclick=moves1(22)></td>');
   document.write('<td> <img name=i23 width=30px height=30px src="" onclick=moves1(23)></td>');
   document.write('<td> <img name=i24 width=30px height=30px src=""  onclick=moves1(24)></td>');
   document.write("</tr>");
   document.write("</table>");
    Array.prototype.inArray = function (value)
    {
